...
ethers_1.ethers.getDefaultProvider("rinkeby")));
var nftCollection = sdk.getNFTModule("<MODULE_ADDRESS>");
// assign the smart contract address
var nft_smart_contract_address = "<NFT_CONTRACT_ADDRESS>";
// Instantiate NFT Collection module
var nft = sdk.getNFTModule(nft_smart_contract_address);
