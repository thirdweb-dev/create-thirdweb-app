...
function handler(lang, module, example, name) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      console.log(
        chalk_1.default.gray("Language: "),
        chalk_1.default.green(lang)
      );
      console.log(
        chalk_1.default.gray("Folder name: "),
        chalk_1.default.green(name)
      );
      console.log(
        chalk_1.default.gray("Example: "),
        chalk_1.default.green(example)
      );
      inquirer_1.default
        .prompt([
          {
              ...
              switch (_a.label) {
                case 0:
                  ...
                  return [
                    4 /*yield*/,
                    download(
                      "create-thirdweb-app-main/".concat(ex.subfolder),
                      pathname
                    ),
                  ];
                case 1:
                  _a.sent();
                  (0,
                  child_process_1.execSync)("cd ".concat(pathname, " && ").concat(ex.install), {
                    stdio: [1],
                  });
                  console.clear();
                  console.log(
                  ...
                  console.log(
                    "run `" +
                      chalk_1.default.green(
                        "cd "
                          .concat(name)
                          .concat(startCommand ? " && " + startCommand : "")
                      ) +
                      "` to get started"
                  );
                  if (ex.guide !== undefined || ex.guide == "") {
                    console.log(
                      "Find accompanying tutorial at ".concat(
                        chalk_1.default.green(ex.guide)
                      )
                    );
                  }
                  console.log(
                ...
                case 2:
                  console.log(
                    chalk_1.default.red("Operation cancelled by user")
                  );
                  _a.label = 3;
                case 3:
                  return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          zip = new node_stream_zip_1.default.async({
            file: "".concat(__dirname, "/temp.zip"),
          });
